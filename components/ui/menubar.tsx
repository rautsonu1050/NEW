  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        ...
        "select-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent",
  ...
  return (
    <MenubarPrimitive.Item
      ...
      className={cn(
        ...
        "py-1.5 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground",
...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-xs py-1.5",
        "pr-2 pl-8 text-sm outline-hidden select-none focus:bg-accent",
