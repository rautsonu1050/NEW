  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4",
        "[&>svg]:shrink-0",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "outline-hidden transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring",
        "outline-hidden transition-transform peer-hover/menu-button:text-sidebar-accent-foreground",
        "hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
        "focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 md:after:hidden",
