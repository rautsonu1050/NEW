...
const tabsListVariants = cva(
  [
    ...
    "rounded-lg p-[3px] text-muted-foreground group-data-[orientation=horizontal]/tabs:h-9",
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "font-medium whitespace-nowrap text-foreground/60 transition-all",
        ...
        "disabled:pointer-events-none disabled:opacity-50 group-data-[variant=default]/tabs-list:data-[state=active]:shadow-sm",
        ...
        "group-data-[orientation=vertical]/tabs:after:-right-1 group-data-[orientation=vertical]/tabs:after:w-0.5",
