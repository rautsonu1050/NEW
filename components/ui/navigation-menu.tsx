    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          ...
          "shadow data-[state=closed]:animate-out data-[state=closed]:zoom-out-95",
          "data-[state=open]:animate-in data-[state=open]:zoom-in-90 md:w-[var(--radix-navigation-menu-viewport-width)]",
          className,
        )}
        {...props}
      />
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        "focus:text-accent-foreground focus-visible:ring-[3px] focus-visible:ring-ring/50",
        "focus-visible:outline-1 data-[active=true]:bg-accent/50 data-[active=true]:text-accent-foreground",
