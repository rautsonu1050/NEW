...
function MessageScrollerViewport({
  ...
  return (
    <MessageScrollerPrimitive.Viewport
      ...
      className={cn(
        "size-full min-h-0 min-w-0 scroll-fade-b scrollbar-thin scrollbar-gutter-stable",
  ...
  return (
    <MessageScrollerPrimitive.Button
      ...
      className={cn(
        ...
        "data-[active=false]:scale-95 data-[active=false]:opacity-0 data-[active=false]:duration-400",
        "data-[active=false]:ease-[cubic-bezier(0.7,0,0.84,0)] data-[active=true]:translate-y-0",
        "data-[active=true]:scale-100 data-[active=true]:opacity-100 data-[active=true]:ease-[cubic-bezier(0.23,1,0.32,1)]",
