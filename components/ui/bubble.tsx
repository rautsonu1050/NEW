...
const bubbleVariants = cva(
  [
    ...
    "gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end",
...
function BubbleContent({
  ...
  return (
    <Comp
      ...
      className={cn(
        "w-fit max-w-full min-w-0 overflow-hidden rounded-xl border border-transparent",
...
const bubbleReactionsVariants = cva(
  [
    ...
    "gap-1 rounded-full bg-muted px-1.5 py-0.5 text-sm ring-3 ring-card",
    "has-[button]:p-0",
  ],
  {
    variants: {
